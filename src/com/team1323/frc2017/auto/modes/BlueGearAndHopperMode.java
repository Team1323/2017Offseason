...
public class BlueGearAndHopperMode extends AutoModeBase{
	...
	public void routine() throws AutoModeEndedException{
		...
		runAction(new PathfinderAction(Drive.getInstance().leftPegTrajectory, true, true, true));
		runAction(new ScoreGearAction());
		runAction(new ParallelAction(Arrays.asList(new Action[]{
				new PathfinderAction(Drive.getInstance().pegToBlueHopperTrajectory, false, false, false),
				new WaitAction(4.0)
		})));
